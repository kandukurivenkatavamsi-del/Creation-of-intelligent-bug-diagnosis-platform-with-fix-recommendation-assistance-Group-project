    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-6">
          <div className="max-w-lg w-full rounded-2xl border border-red-500/20 bg-surface p-6 shadow-2xl text-center">
            ...
            {this.state.error?.message && (
              <div className="rounded-xl border border-red-200 dark:border-white/[0.06] bg-red-50/70 dark:bg-black/40 p-3 mb-5 text-left font-mono text-[11px] text-red-600 dark:text-red-300 overflow-x-auto max-h-28">
                {this.state.error.message}
              </div>
            )}
