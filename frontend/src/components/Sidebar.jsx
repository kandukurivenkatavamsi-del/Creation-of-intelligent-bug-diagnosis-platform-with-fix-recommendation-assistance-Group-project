...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-[278px] shrink-0 flex-col h-screen sticky top-0 overflow-hidden border-r border-white/[0.06] bg-[#090c17]/95 backdrop-blur-2xl">
