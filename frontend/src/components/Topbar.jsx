...
const TITLES = {
  ...
  '/team': [
    'Team & Workspace',
    'Manage members, engineering roles, and onboarding invitations',
  ],
  '/reports': [
    'Reports & Audits',
    'Diagnostic exports, compliance summaries, and remediation briefs',
  ],
  '/bug-prediction': [
    'Bug Prediction',
    'Analyze commit diffs and forecast production bug risks before deploy',
  ],
  '/duplicate-issues': [
    'Duplicate Issues',
    'Detect duplicate defect reports using vector similarity and embeddings',
  ],
  '/profile': [
    'Engineer Profile',
    'View your identity, assigned role, and diagnostic activity',
  ],
}
...
export default function Topbar() {
  ...
  return (
    <header className="relative z-30 flex min-h-[82px] shrink-0 items-center justify-between border-b border-white/[0.05] bg-[#080b15]/95 px-6 py-4 backdrop-blur-2xl">
      ...
      <div className="relative mx-4 hidden max-w-md flex-1 md:block">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full rounded-xl border border-white/[0.07] bg-white/[0.025] py-2 pl-10 pr-4 text-xs text-slate-200 outline-none transition-all placeholder:text-slate-600 focus:border-violet-400/30 focus:bg-white/[0.04]"
            value={searchQuery}
