    ...
    <div className="max-w-[1500px] space-y-6">
      <section className="relative overflow-hidden rounded-3xl border border-violet-400/10 bg-gradient-to-br from-violet-500/[0.07] via-[#0b0f1d] to-cyan-400/[0.035] p-6 lg:p-7">
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          {health && (
            <div className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-white/90 shadow-sm dark:border-white/[0.05] dark:bg-white/[0.02] dark:shadow-none px-4 py-3">
              <div
                className="relative flex h-16 w-16 items-center justify-center rounded-full"
                style={{
                  background: `conic-gradient(${healthColor} ${health.score * 3.6}deg, var(--gauge-track, rgba(255,255,255,0.08)) 0deg)`,
                }}
              >
                <div className="gauge-center-circle flex h-[52px] w-[52px] items-center justify-center rounded-full shadow-sm border">
                  <span className="gauge-score-text text-lg font-bold">
                    {health.score}
                  </span>
                </div>
              </div>
        ...
        <section className="panel overflow-hidden">
          <div className="flex items-center justify-between border-b border-white/[0.05] px-5 py-4">
            ...
            <div className="text-right">
              ...
              <p className="text-[10px] font-medium text-cyan-600 dark:text-cyan-300">
                {health.status}
              </p>
            </div>
          </div>
