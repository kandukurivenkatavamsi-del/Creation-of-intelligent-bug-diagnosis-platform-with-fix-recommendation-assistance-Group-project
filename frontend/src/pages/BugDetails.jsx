                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-violet-400/15 bg-gradient-to-br from-violet-500/[0.08] via-transparent to-cyan-400/[0.04] p-5">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                      <div>
                        ...
                        <h4 className="mt-1.5 text-lg font-semibold text-slate-900 dark:text-white">Overall Bug Risk</h4>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="relative flex h-24 w-24 items-center justify-center rounded-full"
                          style={{
                            background: `conic-gradient(rgb(124 92 255) ${Math.max(0, Math.min(100, analysis.risk_score ?? 0)) * 3.6}deg, var(--gauge-track, rgba(255,255,255,0.08)) 0deg)`
                          }}
                        >
                          <div className="gauge-center-circle flex h-[78px] w-[78px] flex-col items-center justify-center rounded-full shadow-sm border">
                            <span className="gauge-score-text text-2xl font-bold">{analysis.risk_score ?? 0}</span>
                            <span className="gauge-score-subtext text-[9px] uppercase tracking-[0.12em]">of 100</span>
                          </div>
                        </div>
