...
export default function CognitiveTerminal() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Terminal Container */}
      <div className="panel overflow-hidden flex flex-col border border-slate-200 dark:border-white/[0.08] shadow-lg dark:shadow-[0_8px_32px_rgba(0,0,0,0.6)]">
        {/* Terminal Header Bar */}
        <div className="terminal-header-bar flex items-center justify-between border-b border-slate-200 dark:border-white/[0.08] bg-white dark:bg-[#0c1020] px-4 py-3">
          <div className="flex items-center gap-2">
          ...
          <span className="rounded border border-violet-400/20 bg-violet-50 text-violet-700 dark:border-violet-400/30 dark:bg-violet-500/10 dark:text-violet-300 px-2 py-0.5 font-mono text-[10px] font-bold">
            V3.5-SHELL
          </span>
        </div>
        ...
        <div
          ref={screenRef}
          className="terminal-screen h-[480px] overflow-y-auto bg-slate-200 dark:bg-[#04060d] p-5 font-mono text-xs leading-6"
        >
        ...
        {/* Input Bar */}
        <form onSubmit={handleSubmit} className="flex border-t border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-[#0a0d1a] focus-within:ring-1 focus-within:ring-violet-500/50">
          <span className="flex items-center pl-4 font-mono text-xs font-bold text-cyan-700 dark:text-cyan-400 shrink-0 whitespace-nowrap select-none">
            developer@bugsense:~#
          </span>
          <input
            type="text"
            className="w-full bg-transparent px-3 py-3.5 font-mono text-xs text-slate-900 dark:text-white outline-none focus:outline-none focus:ring-0 placeholder-slate-400 dark:placeholder-slate-500"
          ...
          <button
            type="submit"
            className="border-l border-slate-200 dark:border-white/[0.08] bg-violet-600 hover:bg-violet-700 text-white px-6 font-mono text-xs font-bold transition-colors shrink-0"
          >
            EXEC
          </button>
        </form>
